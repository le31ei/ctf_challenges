<?php /* Smarty version 2.6.18, created on 2010-04-23 14:06:41
...
<?php endfor; endif; ?>	
  ...
  <LI class=qq><A href="message.php">在线留言</A> 
  <UL>
  </UL>
  </LI>
...
img/about_12.jpg" 
width=8></DIV>
<H1 class=left><SPAN class=" left">服务与支持</SPAN><SPAN class=right 
style="FONT-WEIGHT: normal"><A class=black 
href="index.php">首页</A> &gt; <A class=black 
href="message.php">在线留言</A> 
</SPAN></H1></DIV>
<DIV class=ncontent_rz>

    <br />
    <form name="form2" method="post" action="message.php" >
  <table width="100%" height="79"
border="0" align="center" cellpadding="0" cellspacing="3">
                                    <tr> 
                                      <td width="23%" height="25" align="right" class="word_bk">姓名： 
                                      </td>
                                      <td width="77%" height="25" class="word_bk"><font> 
                                        <input name="c_name" type="text" class="smallInput" id="name" style="font-size: 14px" maxlength="36">
                                        </font>*</td>
                                    </tr>
                                    <tr>
                                      <td height="25" align="right" class="word_bk">电话：</td>
                                      <td height="-1" class="word_bk"><font>
                                        <input type="text" name="c_phone" maxlength="36" style="font-size: 14px" class="smallInput">
                                      </font>* </td>
                                    </tr>
                                    <tr>
                                      <td height="25" align="right" class="word_bk">E-mail：</td>
                                      <td height="11" class="word_bk"><font>
                                        <input name="c_mail" type="text" class="smallInput" id="email" style="font-size: 14px" size="18" maxlength="36">
                                      </font>*</td>
                                    </tr>
                                   
                                    <tr> 
                                      <td width="23%" height="25" align="right" class="word_bk">主题： 
                                      </td>
                                      <td width="77%" height="25" class="word_bk"><input name="c_title" type="text" class="smallInput" id="topic" style="font-size: 14px" size="42" maxlength="36">
                                        *</td>
                                    </tr>
                                    <tr> 
                                      <td width="23%" height="1" align="right" valign="top" class="word_bk">内容： 
                                      </td>
                                      <td width="77%" height="1" valign="top" class="word_bk"><textarea name="c_content" cols="45" rows="10" class="smallInput" id="body" style="font-size: 14px"></textarea>                                      </td>
                                    </tr>
                                    <tr> 
                                      <td width="23%" height="0" valign="top"> 
                                      </td>
                                      <td width="77%" height="0" valign="top"> 
                                        <input type="submit" value="发布留言" name="submit_message" onClick="return formsubmit();">
...
img/content_50.jpg" 
width=15></DIV></DIV></DIV></BODY></HTML>