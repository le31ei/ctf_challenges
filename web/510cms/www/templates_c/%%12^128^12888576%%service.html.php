<?php /* Smarty version 2.6.18, created on 2010-04-23 14:21:48
...
"><?php echo $this->_tpl_vars['sm_procut'][$this->_sections['p']['index']]['name']; ?>
  ...
  <LI class=qq><A href="service.php">服务与支持</A> 
  <UL>
<?php unset($this->_sections['c']);
$this->_sections['c']['name'] = 'c';
...
$this->_sections['c']['last']       = ($this->_sections['c']['iteration'] == $this->_sections['c']['total']);
?>
    <LI><A href="?listid=<?php echo $this->_tpl_vars['sm_ser'][$this->_sections['c']['index']]['id']; ?>
"><?php echo $this->_tpl_vars['sm_ser'][$this->_sections['c']['index']]['title']; ?>
</A>  </LI>
<?php endfor; endif; ?>	
